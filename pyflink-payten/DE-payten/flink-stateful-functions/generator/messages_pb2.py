...
_GREETRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='greeting', full_name='example.GreetResponse.greeting',
            index=1,
...
GreetRequest = _reflection.GeneratedProtocolMessageType('GreetRequest',
                                                        (_message.Message,),
                                                        dict(
...
GreetResponse = _reflection.GeneratedProtocolMessageType('GreetResponse',
                                                         (_message.Message,),
                                                         dict(
...
SeenCount = _reflection.GeneratedProtocolMessageType('SeenCount',
